...
class Calibration(object):
    ...
    def project_velo_to_ref(self, pts_3d_velo):
        ...
        return np.dot(pts_3d_velo, np.transpose(self.V2C))  # 等价于np.transpose(np.dot(self.V2C, np.transpose(pts_3d_velo)))
    ...
    def project_image_to_rect(self, uv_depth):
        ''' Input: nx3 first two channels are uv, 3rd channel is depth in rect camera coord.
