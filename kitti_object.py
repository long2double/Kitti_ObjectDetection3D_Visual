...
def show_lidar_on_image(pc_velo, img, calib, img_width, img_height):
    ...
    imgfov_pc_velo, pts_2d, fov_inds = get_lidar_in_image_fov(pc_velo, calib, 0, 0, img_width, img_height, True)  # imgfov_pc_velo->pc_velo传入的点云去掉2米内和超出图片的点；pts_2d->传入点云去掉超出图片的点（没有去掉2米内的点）
    imgfov_pts_2d = pts_2d[fov_inds, :]  # 去掉两米内的点
    imgfov_pc_rect = calib.project_velo_to_rect(imgfov_pc_velo)  # 其实imgfov_pc_rect经过内参就可以得到imgfov_pts_2d
